...
input ProductCreateOneWithoutUser_ratingInput {
...
input ProductCreateWithoutUser_ratingInput {
  name: String!
  url: String!
  thumb: String
  featured_image: String
...
input ProductRatingCreateOneWithoutProductInput {
  create: ProductRatingCreateWithoutProductInput
}

input ProductRatingCreateWithoutProductInput {
  aggregate_rating: Float
  votes: Int
}
...
input ProductRatingUpdateOneRequiredWithoutProductInput {
  create: ProductRatingCreateWithoutProductInput
  update: ProductRatingUpdateWithoutProductDataInput
  upsert: ProductRatingUpsertWithoutProductInput
}

input ProductRatingUpdateWithoutProductDataInput {
  aggregate_rating: Float
  votes: Int
}

input ProductRatingUpsertWithoutProductInput {
  update: ProductRatingUpdateWithoutProductDataInput!
  create: ProductRatingCreateWithoutProductInput!
}
...
type User {
  ...
  email: String!
  name: String!
  phone_numbers(where: PhoneNumberWhereInput, orderBy: PhoneNumberOrderByInput, skip: Int, after: String, before: String, first: Int, last: Int): [PhoneNumber!]
  user_type: UserType!
  reviews(where: ReviewWhereInput, orderBy: ReviewOrderByInput, skip: Int, after: String, before: String, first: Int, last: Int): [Review!]
...
input UserCreateOneWithoutPhone_numbersInput {
...
input UserCreateWithoutPhone_numbersInput {
  email: String!
  name: String!
  user_type: UserType
  reviews: ReviewCreateManyWithoutUserInput
